...
printf("\x1b[34m|
 ...
 printf("\x1b[35m| 1. login
 |\x1b[0m\n");
 printf("\x1b[35m| 2. jogar
 printf("\x1b[35m| 3. status
 printf("\x1b[35m| 0. Sair
 |\x1b[0m\n");
 |\x1b[0m\n");
 |\x1b[0m\n");
 printf("\x1b[34m------------------------\n");
...
int jogadorEncontrado =-1;
 ...
 printf("\x1b[41mNão foi encontrado um jogador com essa quantidade de
 jogos.x1b[0m\n");
 } else {
 printf("\x1b[37m-----------------------------\x1b[0m\n");

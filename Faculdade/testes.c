 ...
 int main() {
     ...
     do {
         ...
         switch (opcao) {
             case 1: {
                 printf("Bem-vindo ao quiz sobre a Copa do mundo \n\n");
                 ...
                 char *perguntas[15] = {
                "1. Quando foi realizada a primeira Copa do Mundo de Futebol?",
                "2. Qual país venceu a primeira Copa do Mundo?",
                "3. Quantas seleções participam atualmente da Copa do Mundo?",
                "4. Qual é a única seleção que participou de todas as Copas do Mundo?",
                "5. Qual país tem mais títulos de Copa do Mundo?",
                "6. Quem é o maior artilheiro da história das Copas do Mundo?",
                "7. Quantas vezes o Brasil sediou a Copa do Mundo?",
                "8. Qual jogador brasileiro é conhecido por ter conquistado três Copas do Mundo?",
                "9. Qual foi a primeira Copa do Mundo transmitida pela televisão?",
                "10. Qual seleção é famosa por ter vencido a Copa do Mundo em casa em 1966?",
                "11. Qual foi a primeira seleção africana a chegar nas quartas de final da Copa do Mundo?",
                "12. Qual foi a maior goleada da história das Copas do Mundo?",
                "13. Quem marcou o “Gol do Século” na Copa do Mundo de 1986?",
                "14. Qual foi a última seleção campeã da Copa antes da ampliação para 48 seleções?",
                 "15. Onde será a Copa do Mundo de 2026?",
